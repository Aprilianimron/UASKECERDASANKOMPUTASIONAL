...
Original file is located at
    https://colab.research.google.com/drive/1X8ZPa2BWsmQY3b9tSydMd8v-cOMsQYT5
...
""" Deklarasi Fungsi "inference"  menghitung nilai output fuzzy menggunakan kombinasi emosi dan perasaan -"""
...
"""### - Deklarasi fungsi "defuzzification" untuk melakukan defuzzifikasi atau konversi nilai fuzzy menjadi nilai  yang konkret -"""
...
"""###**Apabila terjadi perubahan pada file Excel, data yang terdapat dalam source code akan berubah secara otomatis. Hal ini disebabkan oleh fakta bahwa kode sumber akan membaca data langsung dari file Excel setiap kali dijalankan. Dengan demikian, setiap perubahan yang terjadi pada file Excel akan segera tercermin dalam source code. Oleh karena itu, ketika kode dijalankan, data yang akan digunakan adalah data terbaru yang diperbarui yang berasal dari file Excel. Dengan pendekatan ini, pastikan bahwa kode selalu menggunakan data terbaru dari file Excel dan melakukan operasi berdasarkan data tersebut. Oleh karena itu, ketika terjadi perubahan pada data dalam file Excel, hasil yang dihasilkan oleh kode juga akan berubah sesuai dengan perubahan tersebut.
